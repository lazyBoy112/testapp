...
import com.sanglv.testapp.Utils
import com.sanglv.testapp.Utils.Companion.CURRENT_POSITION
import com.sanglv.testapp.Utils.Companion.hide
import com.sanglv.testapp.Utils.Companion.show
import com.sanglv.testapp.databinding.ActivityMediaBinding
import com.sanglv.testapp.PlaybackService
...
class MediaActivity : AppCompatActivity() {
    ...
    private fun updatePlayPauseButton(isPlaying: Boolean) {
        binding.btnPlayPause.setImageResource(if (isPlaying) androidx.media3.session.R.drawable.media3_icon_pause else androidx.media3.session.R.drawable.media3_icon_play)
    }
